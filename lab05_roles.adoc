...
- Create a role `samba`, that provides a sambashare to use with a user `sambauser`. This task is hard! Do provide passwords in cleartext here. We will learn later how to use Ansible-Vault. 
