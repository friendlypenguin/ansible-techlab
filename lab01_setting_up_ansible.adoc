...
[TIP]
====
Use `sudo` to elevate your privilege to that of `root`. Be sure to only install the packages using root priviledges, you should do the rest of the lab as user anisble.
====
