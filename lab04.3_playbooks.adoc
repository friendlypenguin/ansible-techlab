...
- If a user has no food specified, use "housekeeper" (have a look at "playbooks_filters" in the online docs)
...
WARNING: Be aware that it is NOT a good idea to set passwords in cleartext. We will learn in the lab about ansible-vault to handle this in a better way. Never ever do this in a productive environment.
